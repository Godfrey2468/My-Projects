...
export default {
    mounted() {
      this.pushEvent("load-schema8", { code: "GER" }, (reply, ref) => {
       
        const editor = new JSONEditor(this.el, {
          schema: reply.schema8,
          startval: reply.spdefault,
        ...
        document
          .getElementById("json-schema-form-submit8")
          .addEventListener("click", (e) => {
            ...
            if (errors.length) {
              ...
              this.pushEvent("submit8", editor.getValue());
              console.log("working")
            }
          });
