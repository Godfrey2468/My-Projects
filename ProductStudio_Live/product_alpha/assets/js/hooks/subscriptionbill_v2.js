...
export default {
    mounted() {
      this.pushEvent("load-schema2", { code: "GER" }, (reply, ref) => {
       
        const editor = new JSONEditor(this.el, {
          schema: reply.schema2,
         // startval: reply.additional,
          disable_collapse: false,
          disable_edit_json: false,
          disable_properties: false,
          no_additional_properties: true,
        });
        console.log(reply.schema2);
        document
          .getElementById("json-schema-form-submit2")
          .addEventListener("click", () => {
            ...
            if (errors.length) {
              ...
              this.pushEvent("submit2", editor.getValue());
              console.log("working")
            }
          });
      });
