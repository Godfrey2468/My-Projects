...
export default {
    mounted() {
      this.pushEvent("load-schema6", { code: "GER" }, (reply, ref) => {
       
        const editor = new JSONEditor(this.el, {
          schema: reply.schema6,
          startval: reply.networknotification,
          disable_collapse: false,
          disable_edit_json: false,
          disable_properties: false,
          no_additional_properties: true,
        });
        console.log(reply.schema6);
        document
          .getElementById("json-schema-form-submit6")
          .addEventListener("click", () => {
            ...
            if (errors.length) {
              ...
              this.pushEvent("submit6", editor.getValue());
              console.log("working")
            }
          });
      });
