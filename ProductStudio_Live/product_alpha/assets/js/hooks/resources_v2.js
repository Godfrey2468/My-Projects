...
export default {
    mounted() {
      this.pushEvent("load-schema7", { code: "GER" }, (reply, ref) => {
       
        const editor = new JSONEditor(this.el, {
          schema: reply.schema7,
        ...
        console.log(reply.schema7);
        document
          .getElementById("json-schema-form-submit7")
          .addEventListener("click", () => {
            ...
            if (errors.length) {
              ...
              this.pushEvent("submit7", editor.getValue());
              console.log("working")
            }
          });
      });
