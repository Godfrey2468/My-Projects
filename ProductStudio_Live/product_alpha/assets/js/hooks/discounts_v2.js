...
export default {
    mounted() {
      this.pushEvent("load-schema3", { code: "GER" }, (reply, ref) => {
       
        const editor = new JSONEditor(this.el, {
          schema: reply.schema3,
        ...
        console.log(reply.schema3);
        document
          .getElementById("json-schema-form-submit3")
          .addEventListener("click", () => {
            ...
            if (errors.length) {
              ...
              this.pushEvent("submit3", editor.getValue());
              console.log("working")
            }
          });
      });
