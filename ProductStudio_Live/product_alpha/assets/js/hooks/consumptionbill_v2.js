...
export default {
    mounted() {
      this.pushEvent("load-schema4", { code: "GER" }, (reply, ref) => {
       
        const editor = new JSONEditor(this.el, {
          schema: reply.schema4,
        ...
        console.log(reply.schema4);
        document
          .getElementById("json-schema-form-submit4")
          .addEventListener("click", () => {
            ...
            if (errors.length) {
              ...
              this.pushEvent("submit4", editor.getValue());
              console.log("working")
            }
          });
      });
