...
export default {
    mounted() {
      this.pushEvent("load-schema5", { code: "GER" }, (reply, ref) => {
       
        const editor = new JSONEditor(this.el, {
          schema: reply.schema5,
          startval: reply.networkrespec,
          disable_collapse: false,
          disable_edit_json: false,
          disable_properties: false,
          no_additional_properties: true,
        });
        console.log(reply.schema5);
        document
          .getElementById("json-schema-form-submit5")
          .addEventListener("click", () => {
            ...
            if (errors.length) {
              ...
              this.pushEvent("submit5", editor.getValue());
              console.log("working")
            }
          });
      });
