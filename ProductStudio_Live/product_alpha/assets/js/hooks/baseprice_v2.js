...
export default {
    mounted() {
      this.pushEvent("load-schema1", { code: "GER" }, (reply, ref) => {
       
        const editor = new JSONEditor(this.el, {
          schema: reply.schema1,
        ...
        console.log(reply.schema1);
        document
          .getElementById("json-schema-form-submit1")
          .addEventListener("click", () => {
            ...
            if (errors.length) {
              ...
              this.pushEvent("submit1", editor.getValue());
              console.log("working")
            }
          });
      });
