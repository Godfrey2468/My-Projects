    ...
    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 9 4-4-4-4"/>
          ...
          <div id="doubleDropdown1" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
            <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="doubleDropdownButton1">
              <li class="list-none">
                <.link navigate={~p"/res/sms"}  class="block px-0 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white" style="text-decoration: none;">SmS</.link>
              </li>
              <li class="list-none">
                <.link navigate={~p"/res/data"}  class="block px-0 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white" style="text-decoration: none;">Data</.link>
              </li>
              <li class="list-none">
                <.link navigate={~p"/res/voice"}  class="block px-0 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white" style="text-decoration: none;">Voice</.link>
              </li>
              <li class="list-none">
                <.link navigate={~p"/res/default"}  class="block px-0 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white" style="text-decoration: none;">Default</.link>
              </li>
            </ul>
        </div>
      </li>
    ...
    <%!-- <.link
        ...
        >
          ...
          >
            ...
            <%!-- <li class="list-none">
        <button id="doubleDropdownButton111" data-dropdown-toggle="doubleDropdown111" data-dropdown-placement="right-start" type="button" class="flex items-center justify-between w-full px-0 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Policy Specification
        <svg class="w-2.5 h-2.5 mr-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 9 4-4-4-4"/>
  </svg></button>
...
<%!-- The logical part here the sample code --%>
