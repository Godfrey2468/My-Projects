# Original JSON data
defmodule ProductAlphaWeb.Jsontransformer do
 ...
 # Logical Json bein passed for Transformation Rules to apply.
 ...
 physical_json = ProductAlphaWeb.Jsontransformer.transform_network_resource(logical_json)
 ...
 #
 physical_json = ProductAlphaWeb.Jsontransformer.transform_inter_acc(logical_json)
 #
 IO.inspect(physical_json, pretty: true)

 #########################################

 physical_json = ProductAlphaWeb.Jsontransformer.transform_policies(logical_json)

 IO.inspect(physical_json, pretty: true)

 ##########################################
 physical_json = ProductAlphaWeb.Jsontransformer.transform_recharge_spec(logical_json)
