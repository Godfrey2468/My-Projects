defmodule Tsbank.CustomersTest do
  ...
  describe "customers" do
    ...
    @invalid_attrs %{dateOfBirth: nil, ficaComplete: nil, firstName: nil, idNumber: nil, lastName: nil, passportNumber: nil, phoneNumber: nil}
    ...
    test "create_customer/1 with valid data creates a customer" do
      valid_attrs = %{dateOfBirth: ~D[2023-08-28], ficaComplete: true, firstName: "some firstName", idNumber: "some idNumber", lastName: "some lastName", passportNumber: "some passportNumber", phoneNumber: "some phoneNumber"}
    ...
    test "update_customer/2 with valid data updates the customer" do
      customer = customer_fixture()
      update_attrs = %{dateOfBirth: ~D[2023-08-29], ficaComplete: false, firstName: "some updated firstName", idNumber: "some updated idNumber", lastName: "some updated lastName", passportNumber: "some updated passportNumber", phoneNumber: "some updated phoneNumber"}
